...
export const PRODUCTS: ProductEntry[] = [
...

  {
    ...
    verdict: 'Safe',
    tone: 'safe',
    metaTitle: 'Is Aquaphor Safe for Perioral Dermatitis?',
    metaDescription: 'Aquaphor Healing Ointment is petrolatum-based and one of the safest occlusive sealants for active PD flares. How and when to use it.',
    h1: 'Aquaphor Healing Ointment and perioral dermatitis',
    directAnswer:
      'Aquaphor Healing Ointment is one of the safest occlusive sealants for perioral dermatitis. It is 41% petrolatum, fragrance-free, and rarely triggers reactions. Apply a thin layer overnight as the final step of your evening routine to lock in moisture and protect the inflamed barrier. The lanolin content can trigger a small subset — patch-test if you have known wool sensitivity.',
    sections: [
      {
        heading: 'Why Aquaphor is a PD recovery essential',
        body: 'Aquaphor is 41% petrolatum (the safest occlusive for PD), plus mineral oil, ceresin (mineral wax), lanolin alcohol, panthenol, glycerin, and bisabolol. The combination creates a semi-permeable barrier — more occlusive than a moisturizer, more breathable than pure petrolatum. It is the standard dermatology recommendation for protecting damaged skin during recovery.',
      },
      {
        heading: 'How to use it during a flare',
        body: 'Apply a thin slick — pea-sized for the whole perioral area — as the final step of your evening routine, after your fragrance-free moisturizer. Use clean fingers, sleep on a clean pillowcase, and reapply only on cleansed skin the next day. Avoid layering Aquaphor under makeup or sunscreen; save it for the overnight occlusive role.',
      },
      {
        heading: 'When NOT to use it',
        body: 'Avoid Aquaphor on actively oozing or weeping PD lesions — it traps the exudate and can worsen secondary infection. If your PD has progressed to that stage, see a dermatologist before adding any occlusive. Also skip Aquaphor if you have known lanolin allergy; switch to pure Vaseline (petrolatum only) which is gentler.',
      },
      {
        heading: 'Aquaphor variants and what to know',
        body: 'Aquaphor Healing Ointment (the original blue-and-white tub) is the PD-safe baseline. Aquaphor Lip Repair is the same formula in a stick — safe. Aquaphor Baby Healing Ointment is identical to the original. Avoid Aquaphor "Soothing Skin Balm" with marigold — botanical extracts add risk. Always check the specific product label.',
      },
    ],
    keyIngredients: [
      { name: 'Petrolatum (41%)', verdict: 'Safe', slug: 'petrolatum' },
      { name: 'Mineral Oil', verdict: 'Safe' },
      { name: 'Lanolin Alcohol', verdict: 'Caution' },
      { name: 'Panthenol (Pro-Vitamin B5)', verdict: 'Safe' },
    ...
    faqs: [
      {
        ...
        a: 'No, but related. Vaseline is 100% petrolatum. Aquaphor is 41% petrolatum plus mineral oil, lanolin alcohol, panthenol, glycerin, and bisabolol. Aquaphor is more emollient and elegant; Vaseline is purer and cheaper. Both are PD-safe; choose by preference.',
      },
      {
        q: 'Can I use Aquaphor on my lips?',
        a: 'Yes — Aquaphor Healing Ointment is excellent on the lips. Aquaphor Lip Repair is the same formula in stick form. Both are PD-safe lip balms and avoid the cinnamon, mint, and fragrance pitfalls of mainstream lip balms.',
      },
      {
        q: 'Is the lanolin in Aquaphor a problem for PD?',
        a: 'For most PD sufferers, no — the lanolin alcohol fraction in Aquaphor is highly purified and tolerated by the vast majority. A small subset with known lanolin/wool allergy should switch to plain Vaseline. If you have eczema-and-PD overlap, consider patch-testing Aquaphor first.',
      },
      {
        q: 'Should I use Aquaphor under makeup?',
        a: 'Generally no — its slick, slightly tacky finish disrupts foundation adhesion and traps it against the skin. Save Aquaphor for overnight use. During the day, use Vanicream or La Roche-Posay Toleriane as your moisturizer base.',
      },
      {
        q: 'How much Aquaphor per application?',
        a: 'A pea-sized amount for the entire perioral area is plenty. Aquaphor goes a long way — over-application creates a heavy, sticky layer that traps heat and bacteria, which can worsen PD. A thin slick is the right amount.',
      },
    ],
