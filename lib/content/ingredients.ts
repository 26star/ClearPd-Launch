...
export const INGREDIENTS: IngredientEntry[] = [
...

  {
    ...
    verdict: 'Caution',
    tone: 'caution',
    metaTitle: 'Petrolatum and Perioral Dermatitis: Use With Caution',
    metaDescription: 'Petrolatum is inert and tolerated by some PD sufferers, but heavy occlusion can trap bacteria and worsen flares for many. Patch-test before regular use.',
    ...
    sections: [
      {
        heading: 'Why petrolatum is mixed for PD',
      ...
      {
        heading: 'When (carefully) to use it',
        body: 'A thin slick of pure petrolatum or Aquaphor as an overnight sealant is the conventional zero-therapy use case — applied over a clean face after a bland moisturizer, in tiny amounts. Avoid layering it under makeup, sunscreen, or during the day when sweat builds. Apply with clean fingers, never a flannel. If you see new redness, papules, or itching after starting it, stop immediately.',
      },
      {
        heading: 'Petrolatum vs alternatives',
        body: 'If your skin tolerates an occlusive, pure petrolatum (Vaseline Original) is the simplest and cheapest. Aquaphor adds lanolin and ceresin — more emollient, but lanolin is itself a documented PD trigger for some. Lighter humectants like glycerin- or hyaluronic-acid-based moisturizers are often safer first choices for daily use; reserve petrolatum for occasional overnight repair.',
      },
      {
        heading: 'Common misconceptions',
        body: 'Petrolatum is sometimes conflated with industrial petroleum. Cosmetic-grade white petrolatum is highly purified to USP standards with a long safety record on intact skin — concerns about PAH (polycyclic aromatic hydrocarbon) contamination apply only to unrefined petroleum. The PD caution is not about toxicity; it is about occlusion behaviour on inflamed perioral skin.',
      },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: 'It is rated 0 (non-comedogenic) — its molecular size is too large to enter pores. The PD concern is different: heavy occlusion can trap heat, sweat, and bacteria against an inflamed barrier, which can prolong or worsen flares even when pores stay clear.',
      },
      {
        q: 'Is petrolatum safe for daily long-term use?',
        a: 'Petrolatum has a 150-year general safety record and is on the FDA OTC monograph as a Category I skin protectant. For PD-prone skin, however, daily long-term occlusion is a coin-flip — some tolerate it well, others see persistent flares. Use sparingly during recovery and watch your own skin response.',
      },
      {
        q: 'Can I use petrolatum on the lips?',
        a: 'Lip use is the most-tolerated application — the lip vermilion is not the perioral skin where PD flares. Aquaphor and Vaseline on the lips themselves are widely accepted. Avoid flavoured or fragranced lip products (Vaseline Lip Therapy with cocoa butter, rosy lips) — the additives, not the petrolatum base, are what trigger PD.',
      },
      {
